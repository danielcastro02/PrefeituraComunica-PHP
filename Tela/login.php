...
<html>
    ...
    <body class="homeimg">
        ...
        <main>
            ...
            <div class="row">
                <form action="../Controle/usuarioControle.php?function=login" class="card col l6 offset-l3 m8 offset-m2 s10 offset-s1 formLoader" method="post">
                    <div class="row center">
                        <h4 class="textoCorPadrao2">Identifique-se</h4>
                    ...
                    <div class="row center">
                        ...
                        <button type="submit" class="btn waves-effect white-text corPadrao2">Identifique-se</button>
                        <div class="row center">

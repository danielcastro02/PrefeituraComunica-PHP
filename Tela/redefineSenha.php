...
<html>
    ...
    <body class="homeimg">
        ...
        <main>
            ...
            <div class="row">
                <form action="../Controle/usuarioControle.php?function=<?php echo isset($_GET['primeiraSenha'])?"primeiraSenha":'redefineSenha' ; ?>"class="card col l8 offset-l2 m10 offset-m1 s10 offset-s1 formLoader" id="formSenha" method="post">

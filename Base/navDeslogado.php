        ...
        <ul class="right">
            <li>
                <a href="<?php echo $loginUrl; ?>" >
                    <div class="chip detalheSuave pulse-button white-text" style=" background-color: #1689e0">
            ...
            <li>
                <a href="<?php echo $pontos; ?>./index.php" class="initLoader hide-on-med-and-down">
...
<div id="modalRegistro" class="modal">
    <div class="modal-content">
        <h4>Registre-se</h4>
        <div class="row">
            <form action="<?php echo $pontos; ?>Controle/usuarioControle.php?function=inserirUsuario" id="formModal" method="post" class="formLoader">
    ...
    <div class="row">
        <div class="col l6 offset-l3 m8 s12 offset-m2 offset-s0 card" >
            <div class="modal-content" style="max-height: 100%; overflow: auto;">
                ...
                <div class="row">
                    <form class="formLoader" action="<?php echo $pontos; ?>Controle/usuarioControle.php?function=login"  method="post">
                        <div class="row center">
                        ...
                        <div class="row center">
                            <a href="#!" class="modal-close waves-effect waves-green btn waves-effect -flat corPadrao3 white-text">Cancelar</a>
                            <button type="submit" class="waves-effect waves-green btn waves-effect -flat corPadrao2 white-text">Identifique-se</button>
                        </div>
                        <div class="row center">
                            <a class="teal-text initLoader" href="<?php echo $pontos ?>Tela/recuperaSenha.php">Esqueci minha senha!</a>
                            <br>
                            Ainda não está cadastrado? 
                            <a class="teal-text modal-trigger" href="#modalRegistro">Registre-se</a>
                        </div>
                        <?php
                        if (isset($_GET['msg'])) {
                            if ($_GET['msg'] == "senhaerrada") {
                                echo "<script>M.toast({html: 'Você errou alguma coisa!<br> Ainda não é cadastrado? <a class='teal-text modal-trigger' href='#modalRegistro'>Registre-se</a>', classes: 'rounded'});</script>";
                            }
                        }
                        ?>
